...
public class Articles2Adaptater extends RecyclerView.Adapter<Articles2Adaptater.ViewHolder> {

    private List<Article> articles;

    public Articles2Adaptater(List<Article> articles) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_article1, parent, false);
