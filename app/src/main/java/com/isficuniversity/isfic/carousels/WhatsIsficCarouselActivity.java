...
public class WhatsIsficCarouselActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whats_isfic_carousel);
        ...
        images = Arrays.asList(
                R.drawable.aff_i, R.drawable.aff_2
        );
